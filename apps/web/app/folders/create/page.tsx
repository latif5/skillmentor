...
import { Folder, ArrowLeft, Loader2, Type, AlignLeft } from "lucide-react";
...
export default function CreateFolderPage() {
  ...
  return (
    <div className="min-h-screen bg-zinc-50/50 relative overflow-hidden flex flex-col">
      <Navbar backLink={{ href: "/folders", label: "Back to Folders" }} />
        ...
        <div className="w-full max-w-lg mb-20 animate-fade-up">
          ...
          <div className="text-center mb-10">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-indigo-100 to-white border border-indigo-50 rounded-2xl shadow-sm mb-6 relative group">
              <Folder size={32} className="text-indigo-600 group-hover:scale-110 transition-transform duration-300" />
            ...
            <h1 className="text-3xl font-bold text-zinc-900 tracking-tight mb-3">Create a new folder</h1>
            <p className="text-zinc-500 text-lg">Organize your study sets for better learning.</p>
          </div>
